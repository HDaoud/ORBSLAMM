You should have received this v4l2loopback version along with ORBSLAMM (https://github.com/HDaoud/ORBSLAMM).
See the original v4l2loopback library at (https://github.com/umlaeute/v4l2loopback)
